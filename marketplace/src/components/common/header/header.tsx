      ...
      >
        ...
        <div className={clsx(classes.navheader, "")}>
          {isAuthenticated() ? (
            ...
            <button
              className={clsx(classes.clickbutton, classes.buttonProf, " ")}
        ...
        <div className="lg:hidden ">
          <button
            className={clsx(classes.sizenav, "cursor-pointer bg-nav mr-10")}
            onClick={toggleMenu}
          ></button>
        </div>
      </nav>
          ...
          >
            ...
            <div className="flex flex-col justify-center items-center text-white h-screen text-3xl space-y-4">
              ...
              <button
                className="cursor-pointer  p-1 rounded-md active:bg-red-900"
                onClick={() =>
                  handleItemClick(isAuthenticated() ? "/profile" : "/login")
                }
              >
